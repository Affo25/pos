...
const Banner2 = () => {
  return (
    <BannerWrapper>
      <Cards className="mb-70" bodyStyle={{ background: '#2D3142', borderRadius: '10px', minHeight: '270px' }} headless>
        <Figure2>
...
const Banner3 = () => {
  return (
    <BannerWrapper>
      <Cards  bodyStyle={{ borderRadius: '10px', minHeight: '270px', background: '#2D3142' }} headless>
        <Figure3>
...
const Banner4 = () => {
  return (
    <BannerWrapper>
      <Cards bodyStyle={{ background: '#2D3142', borderRadius: '10px', minHeight: '270px' }} headless>
