...
const feeStructuresRoutes = require("./routes/feeStructuresRoutes");
...
app.use("/api/classLists", classListRoutes);
app.use("/api/accounts", accountRoutes);
app.use("/api/transactions", transactionRoutes);
app.use("/api/classAttendances", classAttendanceRoutes);
app.use("/api/feeStructures", feeStructuresRoutes);
app.use("/api/feeCollections", feeCollectionRoutes);
app.use("/api/taskManagements", taskManagementRoutes);
